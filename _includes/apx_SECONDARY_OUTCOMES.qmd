...
![Diagnostic plots for CVTRQ (total score). As shown, all assumptions of a linear model are met.](_figures/fig-sec-diagnostic-plots-cvtrq-calc-total.png){#fig-sec-rainplot-cvtrq-calc-total width="100%"}
...
![Diagnostic plots for RCQ. As shown, all assumptions of a linear model are met.](_figures/fig-sec-diagnostic-plots-rcq-calc-total.png){#fig-sec-rainplot-rcq-calc-total width="100%"}
...
![Diagnostic plots for F-Soz-U (total score). As shown, all assumptions of a linear model are met.](_figures/fig-sec-diagnostic-plots-fsozu-calc-total.png){#fig-sec-rainplot-fsozu-calc-total width="100%"}
...
![Diagnostic plots for ORS. As shown, all assumptions of a linear model are met.](_figures/fig-sec-diagnostic-plots-ors-calc-total.png){#fig-sec-rainplot-ors-calc-total width="100%"}
...
![Diagnostic plots for SOI-R (Item 2a). As shown, the assumptions of a linear model are not met.](_figures/fig-sec-diagnostic-plots-soi-total-score.png){#fig-sec-rainplot-soi-total-score width="100%"}
...
![Diagnostic plots for UCLA. As shown, all assumptions of a linear model are met.](_figures/fig-sec-diagnostic-plots-ucla-calc-total.png){#fig-sec-rainplot-ucla-calc-total width="100%"}
...
![Diagnostic plots for BIS-15. As shown, all assumptions of a linear model are met.](_figures/fig-sec-diagnostic-plots-bis-calc-total.png){#fig-sec-rainplot-bis-calc-total width="100%"}
...
![Diagnostic plots for CUSI. As shown, all assumptions of a linear model are met.](_figures/fig-sec-diagnostic-plots-cusi-calc-total.png){#fig-sec-rainplot-cusi-calc-total width="100%"}
...
![Diagnostic plots for SPSI-R. As shown, all assumptions of a linear model are met.](_figures/fig-sec-diagnostic-plots-spsi-calc-total.png){#fig-sec-rainplot-spsi-calc-total width="100%"}
...
![Diagnostic plots for EKK-R. As shown, all assumptions of a linear model are met.](_figures/fig-sec-diagnostic-plots-ekk-calc-total.png){#fig-sec-rainplot-ekk-calc-total width="100%"}
...
![Diagnostic plots for DERS. As shown, the assumptions of a linear model are not met. Thus, the effect was analyzed by fitting a ordinal regression model with treatment group and the randomization strata as factors (offense type, type of CS, external treatment in addition to CSaU), pre module scores as covariate and post module scores as dependent variable. For the dependent variable, values greater than 9 were merged into a single category.](_figures/fig-sec-diagnostic-plots-ders-calc-imp.png){#fig-sec-rainplot-ders-calc-imp width="100%"}
...
![Diagnostic plots for NARQ. As shown, the assumptions of a linear model are not met. Thus, the effect was analyzed by fitting a ordinal regression model with treatment group and the randomization strata as factors (offense type, type of CS, external treatment in addition to CSaU), pre module scores as covariate and post module scores as dependent variable. For the dependent variable, values greater than 4 were merged into a single category.](_figures/fig-sec-diagnostic-plots-narq-calc-ris.png){#fig-sec-rainplot-narq-calc-ris width="100%"}
...
![Diagnostic plots for ESIQ. As shown, the assumptions of a linear model are not met. Thus, the effect was analyzed by fitting a ordinal regression model with treatment group and the randomization strata as factors (offense type, type of CS, external treatment in addition to CSaU), pre module scores as covariate and post module scores as dependent variable. For the dependent variable, values have been categorized into three categories: worsening (increase), no change, improvement (decrease).](_figures/fig-sec-diagnostic-plots-esiq-calc-total.png){#fig-sec-rainplot-esiq-calc-total width="100%"}
...
![Diagnostic plots for BMS. As shown, the assumptions of a linear model were not met. Thus, the effect was analyzed by fitting a ordinal regression model with treatment group and the randomization strata as factors (offense type, type of CS, external treatment in addition to CSaU), pre module scores as covariate and post module scores as dependent variable. For the dependent variable, values greater than 4 were merged into a single category.](_figures/fig-sec-diagnostic-plots-kvm-score.png){#fig-sec-rainplot-kvm-score width="100%"}
...
![Diagnostic plots for HBI-19. As shown, the assumptions of a linear model were not met. Thus, the effect was analyzed by fitting a ordinal regression model with treatment group and the randomization strata as factors (offense type, type of CS, external treatment in addition to CSaU), pre module scores as covariate and post module scores as dependent variable. or the dependent variable, values were dichotomized based on the cut-off greater or equal to 24.](_figures/fig-sec-diagnostic-plots-hbi-calc-total.png){#fig-sec-rainplot-hbi-calc-total width="100%"}
...
![Diagnostic plots for SSIK. As shown, the assumptions of a linear model were not met. Thus, the effect was analyzed by fitting a ordinal regression model with treatment group and the randomization strata as factors (offense type, type of CS, external treatment in addition to CSaU), pre module scores as covariate and post module scores as dependent variable. or the dependent variable, values were dichotomized based on the cut-off greater or equal to 30.](_figures/fig-sec-diagnostic-plots-ssik-calc-total.png){#fig-sec-rainplot-ssik-calc-total width="100%"}
