...
#| warning: false
#| label: tbl-sspi-2
#| tbl-cap: "Baseline values of the SSPI-2. Note, that the SSPI-2 is only defined for participants who have at least one contact offense. [@setoRevisedScreeningScale2017a]"
...
tbl <- sspi %>%
    tbl_summary(
        ...
        label = list(
            sspi_irgendein_besitz_von_kinderpornographie = "Any non-contact offences",
            sspi_mehrere_opfer_unter_15jahre = "More than one contact victims",
            sspi_irgendein_maennliches_opfer_unter_15jahre  = "Any contact victims under 15 years old",
            sspi_irgendein_opfer_unter_12jahre  = "Any contact victims under 12 years old",
            sspi_irgendein_nicht_zur_familie_gehoerendes_opfer_unter15jahre  = "Any extra-familiar contact victims",
...
# save tbl as image
gt::gtsave(tbl_a, file = file.path(here::here("_tables/tbl-sspi-2.pdf")))
gt::gtsave(tbl_a, file = file.path(here::here("_tables/tbl-sspi-2.docx")))
gt::gtsave(tbl_a, file = file.path(here::here("_tables/tbl-sspi-2.png")))
