...
tbl <- tmp_wide %>%
    ...
    dplyr::select(-client_id, -`Violation of probation conditions`, -`Violation of probation conditions, Acute suicide risk`, -`CSEM offense, Acute suicide risk`, -`CSA offense, Other offense (not CSA or CSEM), Acute suicide risk`, recidivism) %>%
    tbl_summary(
        by = treatment
        #type = everything() ~ "categorical"
    ) %>%
