...
#| tbl-cap: "Pre-post comparisons of the WHO-5 Well-Being Index (WHO-5, total score) for the intervention arm. Shown are descriptive values in both time points and raw as well as Bonferroni-Holm adjusted p-values (q) testing the null hypothesis of no change. p-values were computed using paired non-parametric Brunner–Munzel tests."
...
#| tbl-cap: "Pre-post comparisons of the WHO-5 Well-Being Index (WHO-5, total score) for the placebo arm. Shown are descriptive values in both time points and raw as well as Bonferroni-Holm adjusted p-values (q) testing the null hypothesis of no change. p-values were computed using paired non-parametric Brunner–Munzel tests."
...
#| tbl-cap: "Difference of the WHO-5 Well-Being Index (WHO-5, total score) between before (pre) and after (post) each module by trial arm. Shown are descriptive values and raw as well as Bonferroni-Holm adjusted p-values (q) testing the null hypothesis of no difference. p-values were computed using unpaired non-parametric Brunner–Munzel tests."
...
#| tbl-cap: "Pre-post comparison of the Working Alliance Inventory-Short Revised (WAI-SR-T, total score) for the intervention arm. Shown are descriptive values in both time points and raw as well as Bonferroni-Holm adjusted p-values (q) testing the null hypothesis of no change. p-values were computed using paired non-parametric Brunner–Munzel tests. Please note, that the WAI-SR was not assessed after module six, thus only data for the first five modules were available."
...
#| tbl-cap: "Pre-post comparison of the Working Alliance Inventory-Short Revised (WAI-SR-T, total score) for the placebo arm. Shown are descriptive values in both time points and raw as well as Bonferroni-Holm adjusted p-values (q) testing the null hypothesis of no change. p-values were computed using paired non-parametric Brunner–Munzel tests. Please note, that the WAI-SR was not assessed after module six, thus only data for the first five modules were available."
...
#| tbl-cap: "Difference of the Working Alliance Inventory-Short Revised (WAI-SR-T, total score) between before (pre) and after (post) each module by trial arm. Shown are descriptive values and raw as well as Bonferroni-Holm adjusted p-values (q) testing the null hypothesis of no difference. p-values were computed using unpaired non-parametric Brunner–Munzel tests."
...
#| tbl-cap: "Pre-post comparisons of the Working Alliance Inventory-Short Revised (WAI-SR-PO) for the intervention arm. Shown are descriptive values in both time points and raw as well as Bonferroni-Holm adjusted p-values (q) testing the null hypothesis of no change. p-values were computed using paired non-parametric Brunner–Munzel tests. Please note, that the WAI-SR was not assessed after module six, thus only data for the first five modules were available."
...
#| tbl-cap: "Pre-post comparisons of the Working Alliance Inventory-Short Revised (WAI-SR-PO, total score) for the placebo arm. Shown are descriptive values in both time points and raw as well as Bonferroni-Holm adjusted p-values (q) testing the null hypothesis of no change. p-values were computed using paired non-parametric Brunner–Munzel tests. Please note, that the WAI-SR was not assessed after module six, thus only data for the first five modules were available."
