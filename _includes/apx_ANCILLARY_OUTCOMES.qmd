...
![Rainplot for the WHO-5 total score. The norm in Germany is at M = 65.7. The threshold for a clinically relevant change on the WHO-5 is considered to be 10 points difference. [@toppWHO5WellbeingIndex2015]](_figures/fig-anc-who-5-rainplot.png){#fig-anc-who-5-rainplot width=100%}
...
![Estimated marginal means from the MMRM of WAI-SR COACH (total score).](_figures/fig-anc-wai-coach-estimated-marginal-means.png){#fig-anc-wai-coach-estimated-marginal-means width=100%}
