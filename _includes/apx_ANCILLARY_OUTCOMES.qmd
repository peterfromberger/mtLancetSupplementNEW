...
#| tbl-cap: Mixed model for repeated measures (MMRM) for the WAI-SR COACH.
...
#| fig-cap: "Estimated marginal means with 95% confidence intervals of the mixed model for repeated measures (MMRM) for the  WAI-SR COACH"
...
#| tbl-cap: "Comparison of the WAI-SR COACH between before (pre) and after (post) of the first five modules for the intervention arm. The WAI-SR coach has been analyzed using the Brunner-Munzel test for paired data comparing the pre- and post-module scores and adjusting the p-values using the Bonferroni-Holm’s method to control the family-wise error rate."
...
#| tbl-cap: "Comparison of the WAI-SR COACH between before (pre) and after (post) of the first five modules for the placebo arm."
...
#| tbl-cap: "Pre-post differences of the WAI-SR COACH between before (pre) and after (post) of the first five modules. The table shows descriptive statistics as well as the results for the multiple Brunner-Munzel tests for unpaired data."
...
#| tbl-cap: Mixed model for repeated measures (MMRM) for the WAI-SR SUPERVISOR.
...
#| fig-cap: "Estimated marginal means with 95% confidence intervals of the mixed model for repeated measures (MMRM) for the  WAI-SR SUPERVISOR"
...
#| tbl-cap: "Comparison of the WAI-SR SUPERVISOR between before (pre) and after (post) of the first five modules for the intervention arm. The WAI-SR supervisor has been analyzed using the Brunner-Munzel test for paired data comparing the pre- and post-module scores and adjusting the p-values using the Bonferroni-Holm’s method to control the family-wise error rate."
...
#| tbl-cap: "Comparison of the WAI-SR SUPERVISOR between before (pre) and after (post) of the first five modules for the placebo arm."
...
#| tbl-cap: "Pre-post differences of the WAI-SR SUPERVISOR between before (pre) and after (post) of the first five modules. The table shows descriptive statistics as well as the results for the multiple Brunner-Munzel tests for unpaired data."
