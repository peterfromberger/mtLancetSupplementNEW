...
The norm in Germany is M = 65.7 (all) (65.1 (female), 66.3 (male)). Values below 50 are used to diagnose depression. The threshold for a clinically relevant change on the WHO-5 is considered to be 10 points difference [@toppWHO5WellbeingIndex2015].
...
![Rainplot for the WHO-5 total score.](_figures/fig-anc-who-5-rainplot.png){#fig-anc-who-5-rainplot width=100%}
...
#| tbl-cap: Mixed model for repeated measures (MMRM) for the WHO-5.
...
#| fig-cap: Estimated marginal means from the mixed model for repeated measures (MMRM) for the WHO-5.
#| 
...
![Estimated marginal means for the WHO-5.](_figures/fig-anc-who-estimated-marginal-means.png){#fig-anc-who-estimated-marginal-means width=100%}
...
#| tbl-cap: "Comparison of the WHO-5 score between before (pre) and after (post) of each module for the intervention arm. The effect of each module on the WHO-5 total score has been analyzed using the Brunner-Munzel test for paired data for the primary endpoint comparing the pre- and post-module scores and adjusting the p-values using the Bonferroni-Holm’s method to control the family-wise error rate."
...
#| tbl-cap: "Comparison of the WHO-5 total score between before (pre) and after (post) of each module for the placebo arm. The effect of each module on the WHO-5 total score has been analyzed using the Brunner-Munzel test for paired data for the primary endpoint comparing the pre- and post-module scores and adjusting the p-values using the Bonferroni-Holm’s method to control the family-wise error rate."
...
#| tbl-cap: "Difference of the WHO-5 total score between before (pre) and after (post) each module. Differences from baseline (module post - pre) have been compared between the treatment groups exploratively using the Brunner-Munzel test for unpaired data."
...
![Rainplot for the WHO-5 difference from baseline.](_figures/fig-anc-who-5-difference-from-baseline-rainplot.png){#fig-anc-who-5-difference-from-baseline-rainplot width=100%}
...
#| tbl-cap: Mixed model for repeated measures (MMRM) for the WAI-SR (total score; coach).
...
#| fig-cap: "Estimated marginal means with 95% confidence intervals of the mixed model for repeated measures (MMRM) for the  WAI-SR (total score; coach)"
...
![Estimated marginal means from the MMRM of WAI-SR COACH (total score).](_figures/fig-anc-wai-coach-estimated-marginal-means.png){#ffig-anc-wai-coach-estimated-marginal-means width=100%}

#### Pairwise comparisons

The effect of the first five modules on the `r var_name` has been analyzed using the Brunner-Munzel test for paired data for the primary endpoint comparing the pre- and post-module scores and adjusting the p-values using the Bonferroni-Holm’s method to control the family-wise error rate. [@tbl-anc-wai-coach-pre-post-pairwise-intervention] shows descriptive statistics as well as the results of the pairwise comparisons for the intervention arm and [@tbl-anc-wai-coach-pre-post-pairwise-placebo] for the placebo arm.
...
#| tbl-cap: "Comparison of the WAI-SR (total score; coach) between before (pre) and after (post) of the first five modules for the intervention arm. The WAI-SR coach has been analyzed using the Brunner-Munzel test for paired data for the primary endpoint comparing the pre- and post-module scores and adjusting the p-values using the Bonferroni-Holm’s method to control the family-wise error rate."
...
#| tbl-cap: "Comparison of the WAI-SR (total score; coach) between before (pre) and after (post) of the first five modules for the placebo arm."
...
Pre-post differences for the WAI-SR (total score; coach) have been compared between the treatment groups exploratively using the Brunner-Munzel test for unpaired data. [@tbl-anc-wai-coach-diffscore] shows descriptive statistics as well as the results for the multiple Brunner-Munzel tests for unpaired data of the CARES total score.
...
#| tbl-cap: "Pre-post differences of the WAI-SR (total score; coach) between before (pre) and after (post) of the first five modules."
...
#| tbl-cap: Mixed model for repeated measures (MMRM) for the WAI-SR (total score; supervisor).
...
#| fig-cap: "Estimated marginal means with 95% confidence intervals of the mixed model for repeated measures (MMRM) for the  WAI-SR (total score; supervisor)"
...
![Estimated marginal means from the MMRM of WAI-SR SUPERVISOR (total score).](_figures/fig-anc-wai-supervisor-estimated-marginal-means.png){#ffig-anc-wai-supervisor-estimated-marginal-means width=100%}

#### Pairwise comparisons

The effect of the first five modules on the `r var_name` has been analyzed using the Brunner-Munzel test for paired data for the primary endpoint comparing the pre- and post-module scores and adjusting the p-values using the Bonferroni-Holm’s method to control the family-wise error rate. [@tbl-anc-wai-supervisor-pre-post-pairwise-intervention] shows descriptive statistics as well as the results of the pairwise comparisons for the intervention arm and [@tbl-anc-wai-supervisor-pre-post-pairwise-placebo] for the placebo arm.
...
#| tbl-cap: "Comparison of the WAI-SR (total score; supervisor) between before (pre) and after (post) of the first five modules for the intervention arm. The WAI-SR supervisor has been analyzed using the Brunner-Munzel test for paired data for the primary endpoint comparing the pre- and post-module scores and adjusting the p-values using the Bonferroni-Holm’s method to control the family-wise error rate."
...
#| tbl-cap: "Comparison of the WAI-SR (total score; supervisor) between before (pre) and after (post) of the first five modules for the placebo arm."
...
Pre-post differences for the WAI-SR (total score; supervisor) have been compared between the treatment groups exploratively using the Brunner-Munzel test for unpaired data. [@tbl-anc-wai-supervisor-diffscore] shows descriptive statistics as well as the results for the multiple Brunner-Munzel tests for unpaired data of the CARES total score.
...
#| tbl-cap: "Pre-post differences of the WAI-SR (total score; supervisor) between before (pre) and after (post) of the first five modules."
