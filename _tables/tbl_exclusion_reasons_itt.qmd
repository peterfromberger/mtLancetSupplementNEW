...
gt::gtsave(tbl_eq, file = file.path(here::here("paper/clinical_trial_LancetDigitalHealth/tables/tbl-exclusion-reasons-itt.png")))
gt::gtsave(tbl_eq_short, file = file.path(here::here("paper/clinical_trial_LancetDigitalHealth/tables/tbl-exclusion-reasons-itt-short.png")))
