...
create_prim_diff_tbl <- function(data, dvs, label_list, grouping_var, abbreviations, type_list) {
  ...
  tbl <- data %>%
    ...
    # abbreviations
    modify_abbreviation("95% CI = Confidence interval of the estimated relative effect, Q1 = 25th percentile, Q3 = 75th percentile, p-hat = estimated relative effect, q-value = Holm-Bonferroni adjusted p-value, t = Brunner–Munzel test statistic for unpaired samples.")
